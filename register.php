...
if (isset($_POST['register'])) {
    ...
    // PENTING: Karena kolom password kamu hanya 16 karakter, 
    // kita tidak bisa pakai password_hash dulu (hasil hash itu 60 karakter).
    // Kita simpan teks biasa dulu agar tidak error.
    $password = mysqli_real_escape_string($conn, $_POST['password']);

    // SESUAIKAN DENGAN GAMBAR: tabel 'user' (bukan users) dan kolom 'nama'
